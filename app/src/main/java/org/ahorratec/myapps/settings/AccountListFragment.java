package org.ahorratec.myapps.settings;
...
import org.ahorratec.myapps.EmonApplication;
...
public class AccountListFragment extends ListFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        if (EmonApplication.get().getAccounts().isEmpty()) {
            Snackbar snackbar = Snackbar.make(view, "Agregue al menos una cuenta para continuar", Snackbar.LENGTH_INDEFINITE);
